...
#ifndef H_PULSAR_SCRIPT
#define H_PULSAR_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CPulsarAddress
 */
...
public:
    ...
    // Pre-version-0.6, Pulsar always counted CHECKMULTISIGs
