...
static const int64_t MAX_MONEY = 15000000 * COIN; // 15 million
...
inline bool IsPulsatingPOS(int nHeight) { return TestNet() || nHeight > 40000; }
...
public:
    ...
    /** Amount of pulsars spent by this transaction.
    ...
    /** Amount of pulsars coming in to this transaction
